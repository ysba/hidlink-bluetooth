...
typedef enum {
    ...
    HIDLINK_PROTOCOL_COMMAND_STATUS_GET,
    HIDLINK_PROTOCOL_COMMAND_SCAN_START,
    HIDLINK_PROTOCOL_COMMAND_SCAN_STOP,
    HIDLINK_PROTOCOL_COMMAND_SCAN_GET_COUNT,
    HIDLINK_PROTOCOL_COMMAND_SCAN_GET_INFO_BY_INDEX,


    // HIDLINK_PROTOCOL_COMMAND_ATTACH_TO_PERIPHERAL,
    // HIDLINK_PROTOCOL_COMMAND_PERIPHERAL_SCAN_DATA,
    // HIDLINK_PROTOCOL_COMMAND_CLEAR_BOND_DEVICE_LIST,
    // HIDLINK_PROTOCOL_COMMAND_SHOW_LAST_ATTACHED_PERIPHEAL,
    // HIDLINK_PROTOCOL_COMMAND_CONNECT_LAST_ATTACHED_PERIPHEAL,
